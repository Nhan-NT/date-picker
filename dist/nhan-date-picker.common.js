...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_month_picker = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.resolveComponent)("month-picker");

  const _component_day_picker = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.resolveComponent)("day-picker");
  ...
  }, null, 512), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vModelText, $data.selectedDate]]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("i", {
  ...
  }), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", _hoisted_4, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("span", {
    class: "month-value",
    onClick: _cache[4] || (_cache[4] = (...args) => $options.handleSelectMonth && $options.handleSelectMonth(...args))
  }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)($options.renderMonthLabel($data.month)), 1), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("span", _hoisted_5, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)($data.year), 1)]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("i", {
  ...
  })]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)(_component_month_picker, {
    onSetSelectedMonth: $options.setSelectedMonth
  }, null, 8, ["onSetSelectedMonth"]), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vShow, $data.isPickerMonth]]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)(_component_day_picker, {
    days: $data.days,
    prevMonthDays: $data.prevMonthDays,
    selectedDate: $data.selectedDate,
    nextMonthDays: $data.nextMonthDays,
    onSetSelectedDate: $options.setSelectedDate
  }, null, 8, ["days", "prevMonthDays", "selectedDate", "nextMonthDays", "onSetSelectedDate"]), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vShow, $data.isPickerMonth === false]])], 512), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vShow, $data.isPanelOpen]])], 64);
}
...
function DayPickervue_type_template_id_5274da9f_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", DayPickervue_type_template_id_5274da9f_scoped_true_hoisted_1, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", DayPickervue_type_template_id_5274da9f_scoped_true_hoisted_2, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderList)($data.dayLabel, (label, index) => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("span", {
      key: index
    }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(label), 1);
  }), 128))]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", DayPickervue_type_template_id_5274da9f_scoped_true_hoisted_3, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderList)($data.dates, (day, index) => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("span", {
      key: index,
      onClick: $event => $options.setSelectedDate(day),
      class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeClass)([$options.isDateActive(day) && 'active-date', $options.isVisibleDate(day) && 'visible-date'])
    }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(day.getDate()), 11, DayPickervue_type_template_id_5274da9f_scoped_true_hoisted_4);
  }), 128))])]);
}
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/DayPicker.vue?vue&type=script&lang=js
...
function MonthPickervue_type_template_id_93653ebe_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", MonthPickervue_type_template_id_93653ebe_scoped_true_hoisted_1, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderList)(_ctx.months, month => {
    ...
    }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(month.label), 9, MonthPickervue_type_template_id_93653ebe_scoped_true_hoisted_2);
  }), 128))]);
}
;// CONCATENATED MODULE: ./src/components/MonthPicker.vue?vue&type=template&id=93653ebe&scoped=true

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/MonthPicker.vue?vue&type=script&lang=js
...
/******/ })()
;
//# sourceMappingURL=nhan-date-picker.common.js.map